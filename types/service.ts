...
export type ServiceApiMethodType =
...
export type ServiceModelType = 'AdditionalService' | 'AdditionalServiceGeneral';

export type CanSendRequestOptions =
  | CheckPossibilityChangeEWProperties
  | CheckPossibilityBackwardProperties
  | CheckPossibilityReturnProperties;

export type CanSendRequestResponse =
  | CheckPossibilityChangeEWResponse
  | CheckPossibilityBackwardResponse
  | CheckPossibilityReturnResponse;

export type CanSendRequestMethod =
  | 'CheckPossibilityChangeEW'
  | 'CheckPossibilityCreateReturn'
  | 'checkPossibilityForRedirecting';

export type CreateRequestOptions =
  | CreateChangeRequestDocProperties
  | (CreateBackwardRequestToWarehouseProperties | CreateBackwardRequestToDoorProperties)
  | CreateReturnRequestProperties;

export type CreateRequestResponse =
  | CreateChangeRequestDocResponse
  | CreateBackwardRequestResponse
  | CreateReturnRequestResponse;

export type DeleteRequestOptions =
  | DeleteChangeRequestProperties
  | DeleteBackwardRequestProperties
  | DeleteReturnRequestProperties;

export type DeleteRequestResponse = DeleteChangeRequestResponse | DeleteReturnRequestResponse;

export type ListRequestOptions = ListChangesDataProperties | ListBackwardRequestsProperties;

export type ListRequestMethod =
  | 'getChangeEWOrdersList'
  | 'getRedirectionOrdersList'
  | 'getReturnReasons'
  | 'getReturnReasonsSubtypes'
...
export type ListRequestResponse =
  | ListChangesDataResponse
  | ListBackwardRequestsResponse
  | ListReturnReasonsResponse
  | ListReturnReasonsSubtypesResponse;
