export declare type CommonApiMethodType = 'getTimeIntervals' | 'getCargoTypes' | 'getBackwardDeliveryCargoTypes' | 'getPalletsList' | 'getTypesOfPayers' | 'getTypesOfPayersForRedelivery' | 'getPackList' | 'getTiresWheelsList' | 'getCargoDescriptionList' | 'getMessageCodeText' | 'getServiceTypes' | 'getTypesOfCounterparties' | 'getPaymentForms' | 'getOwnershipFormsList';
export declare type CommonModelType = 'Common' | 'CommonGeneral';
