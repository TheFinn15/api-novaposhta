...
export declare type CounterpartyApiMethodType = 'getCounterpartyAddresses' | 'getCounterpartyOptions' | 'getCounterpartyContactPerson' | 'getCounterparties' | 'update' | 'save' | 'delete';
export declare type CounterpartyModelType = 'Counterparty' | 'ContactPerson';
