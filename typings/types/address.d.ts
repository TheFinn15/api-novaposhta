...
export declare type AddressModelType = 'Address' | 'AddressGeneral';
export declare type AddressApiMethodType = 'getStreet' | 'getWarehouses' | 'getSettlements' | 'getAreas' | 'searchSettlements' | 'searchSettlementStreets' | 'delete' | 'save' | 'update' | 'getCities';
