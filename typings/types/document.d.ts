import { DeliveryType, FormatDataType, PaymentMethods, RedeliveryCargoType, RedeliveryPayerType, CargoType, CounterpartyType, PayerType, DocumentFullList } from './enum/document.enum';
import { ReportType } from './index';
export declare type DocumentModelType = 'InternetDocument' | 'TrackingDocument' | 'TrackingDocumentGeneral';
export declare type DocumentApiMethodType = 'getDocumentList' | 'getStatusDocuments' | 'getDocumentsEWMovement' | 'getDocumentTrackingHistory' | 'getDocumentDeliveryDate' | 'getDocumentPrice' | 'update' | 'delete' | 'generateReport';
...
export declare type CreateDocumentProperties = CreateFullInfoDocumentProperties | CreateSimpleDocumentProperties | CreatePostomatDocumentProperties | CreateRedeliveryDocumentProperties;
